...
public class AbbreviationInfoServiceTestConfiguration {
    ...
    AbbreviationInfoService moleculeService() {
        when(abbreviationInfoRepository.getBySynonym("AA")).thenReturn(Optional.of(AbbreviationInfo.builder()
                .id(2L)
                .synonym("AA")
                .em(60.05)
                .mw(60.05)
                ...
                .build()));
        when(abbreviationInfoRepository.getBySynonym("DIPEA")).thenReturn(Optional.of(AbbreviationInfo.builder()
                .id(1L)
                .synonym("DIPEA")
                .em(129.1517496151)
                .mw(129.2470000014)
                ...
                .build()));
        when(abbreviationInfoRepository.getBySynonym("FGR")).thenReturn(Optional.of(AbbreviationInfo.builder()
                .id(3L)
                .synonym("FGR")
                .em(129.1517496151)
                .mw(129.2470000014)
